...
class AppTextStyle {
  ...
  static final TextStyle textBoldBlue15 = TextStyle(
      color: AppColors.corTextBLue, fontSize: 15, fontWeight: FontWeight.bold);

  static final TextStyle textBoldBlue20 = TextStyle(
      color: AppColors.corTextBLue, fontSize: 20, fontWeight: FontWeight.bold);
